...
import { BasicContent } from './elements/general/basicContent.js'
import { NumberInput } from './elements/settings/numberInput'
import { ThemeItem } from './elements/settings/themeItem.js'
import { ThemeItemList } from './elements/settings/themeItemList.js'
...
customElements.define('basic-content', BasicContent)
customElements.define('number-input', NumberInput)
customElements.define('theme-item', ThemeItem)
customElements.define('theme-item-list', ThemeItemList)
